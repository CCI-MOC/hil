...
def upgrade():
    ...
    op.alter_column('headnode', 'id',
               ...
               type_=sa.BigInteger(),
               autoincrement=True,
               existing_server_default=sa.text(u"nextval('headnode_id_seq'::regclass)"))
    ...
    op.alter_column('network', 'id',
               ...
               type_=sa.BigInteger(),
               autoincrement=True,
               existing_server_default=sa.text(u"nextval('network_id_seq'::regclass)"))
    ...
    op.alter_column('project', 'id',
               ...
               type_=sa.BigInteger(),
               autoincrement=True,
               existing_server_default=sa.text(u"nextval('project_id_seq'::regclass)"))
