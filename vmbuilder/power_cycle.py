...
# XXX: this script is pretty terrible. We should either clean it up, or just
# plan to move to using ipmi quickly and junk it.
...
def power_cycle(ip, port='16992', user='admin', pwd='R00tme;R00tme', time=3):
