...
node_macs = [
    'c8:1f:66:e0:ef:2b', # moc01
    'c8:1f:66:e0:ec:25', # moc02
]

ids = range(len(node_macs))
map(create_node, ids)

for n in ids:
    create_nic(n, node_macs[n], 'pxe')
    add_nic(n, n)
create_switch(1, 'dell')
for n in ids:
    create_port(n, 1, n + 13) # machines are in port 13, 14...
    connect_nic(n, n)
